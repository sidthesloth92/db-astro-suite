...
/** Lucide-style "Telescope" line icon. 24px viewBox, stroke="currentColor". */
@Component({
  selector: 'dba-ui-icon-telescope',
  standalone: true,
  templateUrl: './telescope.icon.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { 'aria-hidden': 'true' },
})
export class TelescopeIconComponent {
