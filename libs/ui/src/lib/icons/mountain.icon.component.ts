...
/** Lucide-style "Mountain" line icon. 24px viewBox, stroke="currentColor". */
@Component({
  selector: 'dba-ui-icon-mountain',
  standalone: true,
  templateUrl: './mountain.icon.component.html',
...
export class MountainIconComponent {
  ...
  readonly fill = 'currentColor' as const;
}
