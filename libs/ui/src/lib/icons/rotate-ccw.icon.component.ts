...
/** Lucide-style "Rotate Counter-Clockwise" line icon. 24px viewBox. */
@Component({
  selector: 'dba-ui-icon-rotate-ccw',
  standalone: true,
  templateUrl: './rotate-ccw.icon.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { 'aria-hidden': 'true' },
})
export class RotateCcwIconComponent {
