...
/** Lucide-style "Wand" line icon. 24px viewBox, stroke="currentColor". */
@Component({
  selector: 'dba-ui-icon-wand',
  standalone: true,
  templateUrl: './wand.icon.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { 'aria-hidden': 'true' },
})
export class WandIconComponent {
