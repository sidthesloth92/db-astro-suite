...
// EquipmentItem is a distinct, listable piece of gear (a camera or an optic)
// with aggregate stats and a reverse index of the objects shot with it.
type EquipmentItem struct {
	ID                      string   `json:"id"`
	Kind                    string   `json:"kind"` // "camera" | "optic"
