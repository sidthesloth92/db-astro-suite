 ...
 * the spike preview stage on the left and the slim controls panel on the
 * right (mirroring the starwizz desktop layout).
 */
@Component({
  selector: 'dba-as-root',
  standalone: true,
  imports: [HeaderComponent, SidePanel, SpikeStage],
