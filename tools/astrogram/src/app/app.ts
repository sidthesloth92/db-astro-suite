 ...
 * based on the current viewport width and renders it inside the animated
 * constellation-field background. Everything else lives in the shells.
 */
@Component({
  selector: 'dba-ag-root',
  standalone: true,
  imports: [ConstellationFieldComponent, DesktopShellComponent, MobileShellComponent],
