...
AstroGram is an exposure card generator for astrophotographers. It helps you create beautiful, Instagram-ready cards (4:5 and 9:16 aspect ratios) detailing your equipment and integration times.
...
Navigate to `http://localhost:4201/db-astro-suite/astro-gram`.
