...
- **CHANGES REQUESTED** → hand off to `frontend-dev`, `backend-dev`, or `infra-engineer` with the full review.
- **No E2E coverage for new user flows** → hand off to `e2e-tester`.
