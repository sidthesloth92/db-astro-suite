...
@Component({
  selector: 'hub-astro-card-dossier',
  standalone: true,
    ...
    <div class="dossier-container">
      ...
      <div class="content">
        <nav class="top-nav">
          ...
          <div class="mission-id">Module: AstroCard</div>
        </nav>

        <header class="dossier-header">
          <h1 class="db-neon-text">ASTROCARD</h1>
          <p class="tagline">EXPOSURE CARD & METADATA GENERATOR</p>
        </header>
        ...
        <div class="dossier-grid">
          <section class="briefing">
            <db-card title="Overview">
              <p>
                AstroCard is a high-fidelity utility that allows astrophotographers to generate 
              ...
              <p>
                Documentation is a bridge between science and art. AstroCard ensures your 
        ...
        <footer class="dossier-footer">
          <a href="/db-astro-suite/astrocard/" target="_self" class="launch-btn">
            Launch Tool
          </a>
        </footer>
...
export default class AstroCardPage {}
