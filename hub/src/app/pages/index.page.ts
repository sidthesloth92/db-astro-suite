          ...
          <div class="tools__grid">
            <div class="mission-card" [routerLink]="['/dossier/starwizz']">
              ...
              >
                ...
                <p>
                  Generate high-fidelity starfield videos with surgical control
                  over star count, velocity, and rotation parameters.
                </p>
                <a
            ...
            <div class="mission-card" [routerLink]="['/dossier/astrogram']">
              <dba-ui-card
                ...
                [clickable]="true"
                logoSrc="assets/img/astrogram.png"
              >
                <div class="mission-status">READY</div>
                <p>
                  Astrogram generates beautifully designed and
                  professional-grade Instagram-ready images that display your
                  full astrophotography exposure details, from target and
                  integration time to equipment, filters, and Bortle scale. All
                  in one clean, shareable image.
                </p>
                <a
    ...
    `
      ...
      .hero__title {
        font-size: clamp(
          ...
          6vw,
          40px
        ); /* Fixed max font size for better hierarchy */
