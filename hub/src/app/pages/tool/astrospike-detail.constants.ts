...
export const ASTROSPIKE_DETAIL: ToolDetailConfig = {
  ...
  statusLabel: 'Ready',
  description:
    'Give your astrophotos the diffraction spikes of a Newtonian, the six-armed signature of JWST, or the coloured star halos of a mist filter — without a mask, a filter, or a photo editor. Drop in an image and AstroSpike finds the stars for you, then draws spikes that scale with each star’s real brightness and take their colour from the star itself. Tune the whole field at once, or any single star on its own. Everything runs inside your browser: your image is never uploaded anywhere.',
  ...
  features: [
    ...
    },
    {
      ...
      body: 'Double-click any star for its own length, brightness, rotation, and glow, layered on the globals.',
    },
    {
      icon: targetIcon,
  ...
  steps: [
    ...
    {
      title: 'Fine-tune',
      body: 'Set how many stars get spikes, then their length, colour spread, glow, brightness, and angle.',
    },
    {
