  ...
  '@graph': [
    {
      ...
      featureList: [
        ...
        'Subtle, Classic (4-spike), JWST (6-spike), and Diffusion (spike-free halos and haze) presets',
        'Glow halos and a Mist haze in Diffusion mode — the mist-filter look of Milky Way widefields',
